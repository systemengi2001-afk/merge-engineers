...
export default function Home() {
  ...
  return (
    <main id="top">
      ...
      <section id="team" className="team section"><div className="shell"><div className="sectionHead"><div><p className="sectionTag">TEAM</p><span>04 — TWO PEOPLE, ONE TEAM</span></div><h2>役割は分ける。<br /><em>目的はひとつ。</em></h2><p>営業・顧客対応と制作・開発、それぞれの強みを持ち寄って進めます。</p></div><div className="teamGrid"><article><span>01</span><p>DESIGN / DEVELOPMENT</p><h3>Creative / Development</h3><ul><li>Web Design</li><li>Frontend Development</li><li>System Development</li><li>Automation</li></ul></article><article><span>02</span><p>SALES / PROJECT COMMUNICATION</p><h3>Client / Project</h3><ul><li>Client Communication</li><li>Requirement Discovery</li><li>Project Coordination</li><li>Sales</li></ul></article></div></div></section>
      ...
      <section id="faq" className="faq shell section"><div className="sideTitle"><p className="sectionTag">FAQ</p><span>06 — QUESTIONS</span></div><div><h2>依頼前の、<br /><em>よくある質問。</em></h2><div className="faqList">{faqs.map(([q,a],i)=><details key={q}><summary><span>{String(i+1).padStart(2,'0')}</span>{q}<b>＋</b></summary><p>{a}</p></details>)}</div></div></section>
