    ...
    <main id="top">
      ...
      <section className="hero shell">
        <div className="heroBackdrop" aria-hidden="true">
          <img
            src={`${assetPath}/hero-studio.webp`}
            alt=""
            width="1536"
            height="1024"
            loading="eager"
        ...
        <p className="heroMediaNote"><span>01</span> STUDIO / DIGITAL CRAFT / 2026</p>
      ...
      <section id="about" className="about shell section">
        ...
        <div className="aboutBody"><h2>大きすぎないチームだから、<br /><em>距離が近い。</em></h2><div className="aboutGrid"><p>私たちは、二人で活動するフリーランスエンジニアチームです。相談から制作、公開後まで担当者が変わらず、意図や背景を理解したままプロジェクトを進めます。</p><p>「これってできる？」という段階から歓迎です。技術の話を分かりやすく翻訳し、必要なものを見極め、無駄なく形にします。</p></div><figure className="aboutPhoto"><img src={`${assetPath}/about-worktable.webp`} alt="2人のエンジニアがワイヤーフレームを見ながら設計を進める制作風景" width="1448" height="1086" loading="lazy" decoding="async" /><figcaption><span>HOW IDEAS TAKE SHAPE</span><b>設計と実装を、同じテーブルで。</b></figcaption></figure><div className="strengths"><article><b>01</b><h3>直接話せる</h3><p>つくる本人と話せるから、伝言ゲームがありません。</p></article><article><b>02</b><h3>二つの視点</h3><p>一人で抱え込まず、二人で考え、品質を確かめます。</p></article><article><b>03</b><h3>柔軟に動ける</h3><p>小さな改修から継続支援まで、必要な形で関わります。</p></article></div></div>
      </section>
      ...
      <section id="process" className="process section">
        ...
        <figure className="processPhoto"><img src={`${assetPath}/process-wall.webp`} alt="2人のエンジニアが壁の設計資料を確認している制作風景" width="1672" height="941" loading="lazy" decoding="async" /><figcaption><span>ONE DIRECTION</span><b>見える状態で、認識を重ねる。</b></figcaption></figure>
        <div className="steps">{workflow.map((step)=><article key={step.no}><span>{step.no}</span><div className="stepDot"/><h3>{step.title}</h3><p>{step.text}</p></article>)}</div></div>
      </section>
